...
%UNPATCH_CCS_FILES Utility to unpatch files in a CCS 10 installation
...
%   original files from the backup directory to the CCS install directory
    ...
    ccs_backup_root = fullfile (ccs_install_root, 'ccs_original_files');
    ccs_install_root = fullfile (ccs_install_root, 'ccs');
